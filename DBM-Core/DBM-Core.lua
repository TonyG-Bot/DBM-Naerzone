...
DBM.DefaultOptions = {
	...
	PullVoice = "Corsica",
	ChosenVoicePack2 = (GetLocale() == "enUS" or GetLocale() == "enGB") and "VEM" or (GetLocale() == "esES" or GetLocale() == "esMX") and "JoluSpanish" or "None",
...
--	DontDoSpecialWarningVibrate = false,
	...
	PTCountThreshold2 = 5,
	PlayTT = true,
	PlayTTCountdown = true,
	PlayTTCountdownFinished = true,
	EnableBB = true,
	PlayBBLoot = true,
	PlayBBSound = true,
